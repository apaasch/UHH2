...
inputDatasets = [
    "/JetMET0/Run2023C-PromptReco-v1/MINIAOD",
    "/JetMET0/Run2023C-PromptReco-v2/MINIAOD",
    "/JetMET0/Run2023C-PromptReco-v3/MINIAOD",
    "/JetMET0/Run2023C-PromptReco-v4/MINIAOD",
    "/JetMET1/Run2023C-PromptReco-v1/MINIAOD",
    "/JetMET1/Run2023C-PromptReco-v2/MINIAOD",
    "/JetMET1/Run2023C-PromptReco-v3/MINIAOD",
    "/JetMET1/Run2023C-PromptReco-v4/MINIAOD"
]
...
config = config()
config.General.workArea = 'JetMET' # Don't forget to adjust this
