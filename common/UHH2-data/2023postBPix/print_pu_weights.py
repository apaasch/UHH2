...
path = "."
data_file = TFile.Open('./MyDataPileupHistogram_2023postBPix.root')
mc_file = TFile.Open('./MyMCPileupHistogram_2023postBPix.root')
...
a.SaveAs("PileupProfile_2023postBPix.png")
