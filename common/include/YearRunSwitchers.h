...
public:
  ...
  void setupUL16preVFP(std::shared_ptr<uhh2::AnalysisModule> module);
  void setupUL16postVFP(std::shared_ptr<uhh2::AnalysisModule> module);
  ...
  void setupUL17(std::shared_ptr<uhh2::AnalysisModule> module);
